  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal row">
        <div class="col-sm-6">
            <div class="chekout-box-item">
                <div class="row">
                   <h3 class='checkout-title-text'>Персональные данные</h3>
                </div>
        <fieldset id="account">
        ...
        <label for='reg-input' class="login-page-btns register-page-btns">
              ...
              <span>Продолжить <i class="material-icons">input</i></span>
        </label>
        </div>
      ...
      <div class="col-sm-6">
            <div class="chekout-box-item">
                <div class="row">
                   <h3 class='checkout-title-text'><?php echo $text_your_address; ?></h3>
                </div>  
        <fieldset id="address">
          ...
          <div class="form-group">
            <label class="col-sm-12 control-label" for="input-address-1">Адрес</label>
            <div class="col-sm-12">
        ...
        <input type="radio" name="newsletter" value="1" checked="checked" id='news1' class='hidden' />    
        <input type="checkbox" name="agree" value="1" checked="checked" id='news5' class='hidden' />
